...
<template>
  <span class="inline-flex max-w-full items-center min-h-24px rounded-6px border px-8px pb-4px pt-3px text-12px font-650 leading-[1.35] tracking-0 whitespace-nowrap" :class="badgeClass">
