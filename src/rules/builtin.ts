...
export const builtinGroupDefs: RawGroupDef[] = [
  { id: 'zhihu', name: '知乎', domain: 'zhihu.com', ruleIds: ['zhihu-transform', 'zhihu-autojump'] },
  { id: 'csdn', name: 'CSDN', domain: 'csdn.net', ruleIds: ['csdn-rewrite-open', 'csdn-autojump'] },
  { id: 'juejin', name: '掘金', domain: 'juejin.cn', ruleIds: ['juejin-transform', 'juejin-autojump'] },
  { id: 'jianshu', name: '简书', domain: 'jianshu.com', ruleIds: ['jianshu-transform', 'jianshu-autojump'] },
  { id: 'weibo', name: '微博', domain: 'weibo.com', ruleIds: ['weibo-transform', 'weibo-autojump'] },
  { id: 'baidu', name: '百度搜索', domain: 'baidu.com', ruleIds: ['baidu-transform'] },
  { id: 'bing', name: 'Bing 搜索', domain: 'bing.com', ruleIds: ['bing-transform'] },
  { id: 'google', name: 'Google 搜索', domain: 'google.com', ruleIds: ['google-transform', 'google-autojump'] },
  { id: 'douban', name: '豆瓣', domain: 'douban.com', ruleIds: ['douban-autojump'] },
  { id: 'wechat', name: '微信', domain: 'weixin.qq.com', ruleIds: ['wechat-autojump'] },
  { id: 'wechat-community', name: '微信开放社区', domain: 'developers.weixin.qq.com', ruleIds: ['wechat-community-rewrite', 'wechat-community-autojump'] },
  { id: 'qqmail', name: 'QQ 邮箱', domain: 'mail.qq.com', ruleIds: ['qqmail-rewrite', 'qqmail-autojump'] },
  { id: 'txc', name: '腾讯兔小巢', domain: '(txc|support)\\.qq\\.com', isRegex: true, ruleIds: ['txc-transform', 'txc-autojump'] },
  { id: 'docsqq', name: '腾讯文档', domain: 'docs.qq.com', ruleIds: ['docsqq-autojump'] },
  { id: 'pcqq', name: 'PC 版 QQ', domain: 'qq.com', ruleIds: ['pcqq-autojump'] },
  { id: 'coolapk', name: '酷安', domain: 'coolapk.com', ruleIds: ['coolapk-autojump'] },
  { id: 'bilibili', name: '哔哩哔哩游戏', domain: 'bilibili.com', ruleIds: ['bilibili-autojump'] },
  { id: 'gitee', name: '码云', domain: 'gitee.com', ruleIds: ['gitee-transform', 'gitee-autojump'] },
  { id: 'gitcode', name: 'GitCode', domain: 'gitcode.com', ruleIds: ['gitcode-rewrite', 'gitcode-autojump'] },
  { id: 'oschina', name: '开源中国', domain: 'oschina.net', ruleIds: ['oschina-transform', 'oschina-autojump'] },
  { id: '51cto', name: '51CTO', domain: 'blog.51cto.com', ruleIds: ['51cto-rewrite'] },
  { id: 'tcn', name: '微博短链接', domain: 't.cn', ruleIds: ['tcn-autojump'] },
  { id: 'yuque', name: '语雀', domain: 'yuque.com', ruleIds: ['yuque-autojump'] },
  { id: 'leetcode', name: '力扣', domain: 'leetcode.cn', ruleIds: ['leetcode-transform', 'leetcode-autojump'] },
  { id: 'nga', name: 'NGA', domain: 'nga.cn', ruleIds: ['nga-transform'] },
  { id: 'sspai', name: '少数派', domain: 'sspai.com', ruleIds: ['sspai-transform', 'sspai-autojump'] },
  { id: 'so', name: '360 搜索', domain: 'so.com', ruleIds: ['so-transform'] },
  { id: 'sogou', name: '搜狗搜索', domain: 'sogou.com', ruleIds: ['sogou-transform'] },
  { id: 'afdian', name: '爱发电', domain: 'afdian.com', ruleIds: ['afdian-transform', 'afdian-autojump'] },
  { id: 'linuxdo', name: 'LINUX DO', domain: 'linux.do', ruleIds: ['linuxdo-transform'] },
  { id: 'nodeseek', name: 'NodeSeek', domain: 'nodeseek.com', ruleIds: ['nodeseek-transform', 'nodeseek-autojump'] },
  { id: 'nowcoder', name: '牛客网', domain: 'nowcoder.com', ruleIds: ['nowcoder-transform', 'nowcoder-autojump'] },
  { id: 'ld246', name: '链滴', domain: 'ld246.com', ruleIds: ['ld246-transform', 'ld246-autojump'] },
  { id: 'tencentcloud', name: '腾讯云社区', domain: 'cloud.tencent.com', ruleIds: ['tencentcloud-transform', 'tencentcloud-autojump'] },
  { id: 'infoq', name: 'InfoQ', domain: 'infoq.cn', ruleIds: ['infoq-rewrite', 'infoq-autojump'] },
  { id: 'huaban', name: '花瓣网', domain: 'huaban.com', ruleIds: ['huaban-autojump'] },
  { id: 'bookmarkearth', name: '书签地球', domain: 'bookmarkearth.cn', ruleIds: ['bookmarkearth-transform', 'bookmarkearth-autojump'] },
  { id: 'kdocs', name: '金山文档', domain: 'kdocs.cn', ruleIds: ['kdocs-autojump'] },
  { id: 'shimo', name: '石墨文档', domain: 'shimo.im', ruleIds: ['shimo-rewrite', 'shimo-autojump'] },
  { id: 'steam', name: 'Steam 社区', domain: 'steamcommunity.com', ruleIds: ['steam-autojump'] },
  { id: 'acgbox', name: 'ACG 盒子', domain: 'acgbox.link', ruleIds: ['acgbox-transform', 'acgbox-autojump'] },
  { id: 'pixiv', name: 'Pixiv', domain: 'pixiv.net', ruleIds: ['pixiv-transform', 'pixiv-autojump'] },
  { id: 'facebook', name: 'Facebook', domain: 'facebook.com', ruleIds: ['facebook-transform', 'facebook-autojump'] },
  { id: 'twitter', name: 'Twitter / X', domain: '(twitter\\.com|x\\.com)', isRegex: true, ruleIds: ['twitter-transform'] },
  { id: 'youtube', name: 'YouTube', domain: 'youtube.com', ruleIds: ['youtube-transform', 'youtube-autojump'] },
  { id: 'instagram', name: 'Instagram', domain: 'instagram.com', ruleIds: ['instagram-transform', 'instagram-autojump'] },
]
...
export function buildRuleGroups(rules: Rule[], groupDefs: RawGroupDef[]): RuleGroup[] {
  ...
  return groupDefs.map(def => ({
    id: def.id,
    name: def.name,
    // domain / isRegex 写死在每个分组定义中，直接透传
    domain: def.domain ?? '',
    isRegex: def.isRegex,
    enabled: true,
    rules: def.ruleIds
